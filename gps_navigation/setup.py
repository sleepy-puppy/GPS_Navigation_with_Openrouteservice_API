...
setup(
    ...
    py_modules=[
        'gps_navigation.openrouteservice_py.openrouteservice.openrouteservice_navigation_api',
    ...
    entry_points={
        'console_scripts': [
            'gps_listener_node = gps_navigation.openrouteservice_py.openrouteservice.openrouteservice_navigation_api:main',
